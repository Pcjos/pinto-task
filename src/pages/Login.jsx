          ...
          <div>
            ...
            <div className="flex flex-col -mt-28 absolute px-12 w-full md:top-1/3 md:pt-12 md:left-1/2  md:w-1/3 md:mx-40">
              ...
              <div className="relative mb-4">
                <input
                  className="border-2 border-white p-2 md:p-4 pr-10 focus:outline-none bg-clip-text placeholder-white text-white text-sm w-full"
                  type="text"
                  placeholder="Email"
                />
              ...
              <p className="text-white text-sm md:text-base p-2">
                Forgot Password?
              </p>
            </div>
          </div>
          <div>
            <div className=" md:hidden -ml-12 mt-52 brightness-200">
              <CircleSmallLeftCorner />
            </div>
